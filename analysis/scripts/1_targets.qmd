...
tryCatch({
  ...
  ggplot2::ggsave(file.path(plot_dir, "ozone_vs_solar_r_raw.png"), p_solar, width = 4, height = 3.5, dpi = 600)
  ggplot2::ggsave(file.path(plot_dir, "raw_plots_ozone_wind_temp.png"), p_combined, width = 8, height = 7, dpi = 600)
  p_combined
}, error = function(e) {
...
tryCatch({
  ...
  ggplot2::ggsave(file.path(plot_dir, "effect_wind_by_temp.png"), p_eff_temp, width = 8, height = 4, dpi = 600)
  ggplot2::ggsave(file.path(plot_dir, "effect_wind_by_solar_r.png"), p_eff_solar, width = 8, height = 4, dpi = 600)
  p_eff_temp
}, error = function(e) {
