...
install_script <- file.path(project_root, "analysis", "scripts", "setup", "install_packages.R")
...
tar_option_set(format = "rds", 
               ...
               packages = c(
                 ...
                 "bayesplot", "ggdag", "ggraph", "cmdstanr", "rstan", "targets", "patchwork", "testthat"))
```
...
tar_target(setup_unit_tests, {
  ...
  pipeline_packages <- c(
    "tidyverse", "janitor", "modelr", "tidybayes", "brms",
    "bayesplot", "ggdag", "ggraph", "cmdstanr", "targets", "patchwork", "testthat"
  )
